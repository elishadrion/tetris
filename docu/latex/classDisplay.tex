...
\hypertarget{classDisplay_a428252a4853e5d700d8a0fa9fe0f21e1}{}\index{Display@{Display}!update\+Collection@{update\+Collection}}
\index{update\+Collection@{update\+Collection}!Display@{Display}}
\subsubsection[{update\+Collection(int, int $\ast$)=0}]{\setlength{\rightskip}{0pt plus 5cm}virtual void Display\+::update\+Collection (
\begin{DoxyParamCaption}
\item[{int}]{, }
\item[{int $\ast$}]{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [pure virtual]}}\label{classDisplay_a428252a4853e5d700d8a0fa9fe0f21e1}


Implémenté dans \hyperlink{classCLI_acc4aa511cf5ee13f00323fd7d4e8a4b1}{C\+L\+I}.
