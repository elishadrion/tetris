...
\subsubsection*{Originalité du contenu}
Un joueur va toujours être à la recherche de nouveau contenu. Notre objectif sera de le lui apporter afin que notre jeu ne ressemble à aucun autre jeu auquel il aurait joué dans le passé.
...
Plusieurs joueurs peuvent se connecter/être connectés en même temps sur notre serveur.
Ce dernier va donc être capable d'offrir à tous nos joueurs les mêmes fonctionnalités et doit tenir compte des possibles latences/bugs qu'ils pourraient y avoir sur le reseau.
