...
\underline{Cas général:} 
 Le programme vérifie que le pseudo et le mot de passe est correcte pour permettre à l'utilisateur de profiter des fonctionnalités de l'application.\\
...
\underline{Cas général:} 
 Lorsque le joueur désire consulter ses cartes, l'application doit chargée celle gagné grâce à ses victoires mais également les cartes qu'il à reçu à son inscription.\\
\underline{Cas exceptionnels:} 
 \\
...
\underline{Post-conditions:} 
 Afficher les decks\\
\underline{Cas général:} 
 Le joueur demande à voir la liste de ses deck pour organiser ses cartes et créer une stratégie pour la partie.  Il peut créer, supprimer et modifier les decks.  L'application doit vérifier que le joueur à toujours au moins un deck.\\
\underline{Cas exceptionnels:} 
 \\
