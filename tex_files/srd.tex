...
\newglossaryentry{sort} {
  name=Sort,
  description=Carte ayant un coût en énergie et un effet spécial.
}

\newglossaryentry{crea} {
  name=Créature,
  description={Carte ayant un coût en énergie, une valeur d'attaque et des
...
Ils peuvent chacun poser 7 cartes monstres sur le plateau et ils ne peuvent avoir plus de 7 cartes en main.  À la fin d'un tour, si un joueur a plus de 7 cartes en main, il devra décider de quelles cartes il souhaite se défausser pour arriver à nouveau à cette limite de 7 cartes.
Si un des joueurs ne possède plus de cartes dans son deck, il perdra 3 points de vie à chaque début de tour.
