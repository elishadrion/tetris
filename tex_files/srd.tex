...
La partie se termine lorsqu'un joueur arrive à 0 (ou moins) point de vie.  Il aura donc perdu la partie.  Le joueur vainqueur recevra une carte.  Cette carte sera choisie aléatoirement parmi toutes les cartes disponibles dans le jeux.
